...
complete -c riverctl -n '__fish_riverctl_complete_arg 1' -a 'main-count'             -d 'Get or set the number of views in the main area of the layout'
...
complete -c riverctl -n '__fish_riverctl_complete_arg 1' -a 'stack-pos'              -d 'Get or set the position of the focused view in the stack'
...
complete -c riverctl -n '__fish_riverctl_complete_arg 1' -a 'switch-area'            -d 'Switch between the main and secondary areas of the layout'
complete -c riverctl -n '__fish_riverctl_complete_arg 1' -a 'systemd-ready'          -d 'Inform systemd about service startup completion'
